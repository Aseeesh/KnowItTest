...
const ROUTER_STATE_NAME='router' 

export const selectRouter = createFeatureSelector<RouterReducerState<RouterStateUrl>>(ROUTER_STATE_NAME);

export const getCurrentRoute = createSelector(selectRouter, (router) => {    return router.state})
